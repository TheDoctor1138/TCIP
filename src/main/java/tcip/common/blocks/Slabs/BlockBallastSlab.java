package tcip.common.blocks.Slabs;
...
public class BlockBallastSlab extends BlockSlab
{
    ...
    {
        return isBlockSingleSlab(this) ? Item.getItemFromBlock(this) : (this == BlockIDs.ballastDoubleSlab.block ? Item.getItemFromBlock(BlockIDs.ballastSlab.block) : Item.getItemFromBlock(train.common.library.BlockIDs.oreTC.block));
    }
    ...
    {
        return train.common.library.BlockIDs.oreTC.block.getIcon(side, 3);
    }
}